...
The PR body is generated by [`scripts/build-pr-body.sh`](../scripts/build-pr-body.sh) from the JSON report and includes:

- a processing summary (registered TODOs, new issues, glued TODOs),
- a collapsible list of updated files,
