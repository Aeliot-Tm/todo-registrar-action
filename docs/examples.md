...
Workflow snippets for common setups. Replace `@2.1.0` with the [release version](https://github.com/Aeliot-Tm/todo-registrar-action/releases) you want to pin.
...
```yaml
- uses: Aeliot-Tm/todo-registrar-action@2.1.0
  with:
